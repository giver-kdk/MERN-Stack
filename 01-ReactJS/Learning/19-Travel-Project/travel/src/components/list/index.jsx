...
export default function list(props)
{
	return (
		<div className="item">
			<img src={props.item.imgURL} alt={props.item.title} className="photo" />
			<div className="info">
				<div className="geo">
				...
				<div className="place">{props.item.title}</div>
				<div className="timing">{`${props.item.startDate} - ${props.item.endDate}`}</div>
				<div className="detail">{props.item.description}</div>
			</div>
		</div>
	);
}